import { NamedColorsPalette, NamedColorsProviderProps } from 'named-color-maps/NamedColorsProvider'
import { isHex, isRgb, isRgba } from 'named-color-maps/rgbToHex'

export const selectColorFromPalette = (palette: NamedColorsPalette, shadedColors: NamedColorsProviderProps['shadedColors'], colorOrName: string, defaultColor?: string): string | undefined => {
    ...
    if(colorOrName.indexOf('_') === 0) {
        ...
        const colorKey = colorNamePath[0].slice(1) as keyof typeof shadedColors
